...
class Game(ShowBase):
    def __init__(self):
        ...
        self.land2 = Mapmanager()
        self.land2.loadLand('land3.txt')
        ...
        textObject = OnscreenText(text = 'Builder online', pos = (-1.4, 0.8), scale = 0.07, bg = (random(),random(),random(),1)) 
        textObject2 = OnscreenText(text = 'Reach the top of the skyscraper!', pos = (-1.2, 0.7), scale = 0.07, bg = (random(),random(),random(),1)) 
        imageObject = OnscreenImage(image='panda.png', pos=(-1.5, 0, 0.6), scale = 0.09) 
game = Game()
game.run()